    ...
    <section id="about">
      ...
      <div className={`container ${styles.about__container}`}>
        ...
        <div className={`${styles.about__content}`}>
          ...
          <p>
            I have been a technical support specialist for eight years, looking
            into making a career in the Web and Software Development industry. I
            have been teaching myself how to code for more than a year and also
            completed the Zuitt Coding Bootcamp. As technical support, I love
            solving problems with minimum supervision.
          </p>
